...
c.RSCFlag = 2;  % 0: switch, 1: pitch control, 2: variable speed.
...
c.Wr    = 1.0053                  * time;
c.fcd   = 0.95;
c.anw   = 0.238*(2*pi)            * time;
c.z1nw  = 0.01;
c.z2nw  = 0.10;
c.anb   = 0.239*(2*pi)            * time;
c.z1nb  = 0.04;
c.z2nb  = 0.40;
...
c.z2np  = 0.10;
% -----------------------
c.aF    = 0.238*(2*pi)            * time;
c.zetaF = 0.1;
c.azF   = 0.2*(2*pi)              * time;
c.apF   = 0.4*(2*pi)              * time;
% -----------------------
c.aS    = 0.239*(2*pi)            * time;
c.zetaS = 0.1;
c.azS   = 0.22*(2*pi)             * time;
c.apS   = 0.28*(2*pi)             * time;
% -----------------------
