...
for jdof = 1:3
   ...
   dTT = (TB0g*dTBB0(:,jc3+[1:3])).';

   dQ(1:3,jc12+[1:3])   = dTT;
   dQ(1:3,jc12+4)       = dTT*TB0g*dTBB0(:,1:3)*r ...
                        + TgB*TB0g*d2TBB0(:,jc9+[1:3])*r;
   dQ(1:3,jc12+5)       = dTT*TB0g*dTBB0(:,4:6)*r ...
                        + TgB*TB0g*d2TBB0(:,jc9+[4:6])*r;
   dQ(1:3,jc12+6)       = dTT*TB0g*dTBB0(:,7:9)*r ...
                        + TgB*TB0g*d2TBB0(:,jc9+[7:9])*r;
   dQ(4:6,jc12+[4:6])   = dTT*Fmat + TgB*dFmat(:,jc3+[1:3]);
   dQ(4:6,jc12+[10:12]) = dTT*Gmat + TgB*dGmat(:,jc3+[1:3]);
...
for jdof = 1:3
   ...
   dQ(4:6,jc12+[10:12]) = TgB*dGmat(:,9+jc3+[1:3]);
